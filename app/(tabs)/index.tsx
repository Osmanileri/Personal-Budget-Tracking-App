...
export default function Dashboard() {
  ...
  // Haftanın başlangıç ve bitiş tarihini hesaplar, haftalık harcamayı bulur
  ...
  // Kayıt silme işlemini gerçekleştirir ve hata yönetimi yapar
  ...
  // Updates weekly budget and performs error checking
  ...
  // Ana ekranın arayüzü ve içerik yapısı
  return (
    <View style={styles.container}>
      {/* Üst kısım: Bakiye, gelir, gider ve haftalık bütçe */}
      <LinearGradient colors={['#8b5cf6', '#7c3aed']} style={styles.header}>
        {/* Bakiye ve çıkış butonu */}
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statLabel}>Expenses  
        ...
        {/* Weekly budget and spending progress bar */}
      ...
      {/* Haftalık bütçe düzenleme modalı */}
      <Modal
